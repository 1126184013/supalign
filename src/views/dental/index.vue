    ...
    <div class="content">
      ...
      <div class="middle" v-if="procedure == 0">
        <div class="title">
          ...
          <el-button class="custom-button" size="large" type="primary" @click="">批量上传</el-button>
        </div>
        <div class="box">
          <div class="item">
            <div class="title_1">
          ...
          <div class="item">
            <div class="btn_box">
              <div class="btn" @click="analyze">开始分析</div>
            </div>
          </div>
        </div>
      </div>
